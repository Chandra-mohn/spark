"""Lite pipeline: stats-lite variant for minimal-input workbooks.
...
from spark_pdm_generator.emitters.drawio_emitter import emit_drawio
...
from spark_pdm_generator.engine.estimator import (
    estimate_record_lengths,
    fill_missing_row_counts,
)
...
def run_lite_pipeline(
    ...
    Args:
        ...
        output_dir: Directory for DDL files.
    ...
    # Diagram (Draw.io -- editable in diagrams.net)
    diagram_path = output_dir / "physical_model.drawio"
